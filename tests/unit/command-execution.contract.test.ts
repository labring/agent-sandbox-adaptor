...
import type { MinimalProviderConnection } from '@/adapters/MinimalProviderAdapter';
import { MinimalProviderAdapter } from '@/adapters/MinimalProviderAdapter';
import type { ExecuteOptions, StreamHandlers } from '@/types';
import { MockSandboxAdapter } from '../mocks/MockSandboxAdapter';

/**
 * Contract tests for command execution operations.
 *
  ...
  describe('Native Command Execution (MockSandboxAdapter)', () => {
    ...
    describe('Streaming Execution', () => {
      ...
      it('should call onComplete with result', async () => {
        let completedResult: { exitCode?: number | null } | undefined;
